...
export default function SidebarButton({ sidebarOpen }: any) {
    ...
    return (
        <div className={`w-5 h-20 bg-white fixed ${sidebarOpen ? 'left-0' : 'left-[300px]'}  top-[380px]  flex items-center justify-center rounded-r-md cursor-pointer select-none`}>
            {
                sidebarOpen ? (
                    <IoIosArrowForward />
